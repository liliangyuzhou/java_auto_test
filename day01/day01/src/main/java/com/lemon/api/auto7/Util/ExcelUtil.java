package com.lemon.api.auto7.Util;

import com.lemon.api.auto7.pojo.Case;
import com.lemon.api.auto7.pojo.Rest;
...
public class ExcelUtil {
    ...
    static {
        loadRownumAndCellName("src/main/resources/testcase_V6.xlsx","register");
    }
     ...
     * @param sheetname
     */
    private static void loadRownumAndCellName(String excelpath, String sheetname) {
...
//            }
    ...
    /**批量回写数据到excel中的方法
     * @param excelpatch excel文件路径
     */
    public static void batchWriteBackDatas(String excelpatch) {


        InputStream inputStream = null;
        OutputStream outputStream = null;
        try {
            inputStream= new FileInputStream(new File(excelpatch));
             Workbook workbook=WorkbookFactory.create(inputStream);
            for (WriteBackData writeBackData:writeBackDatas) {
               ...
               //获取列索引
                ...
                outputStream =new FileOutputStream(new File(excelpatch));
                workbook.write(outputStream);
